...
export function NewsPage() {
    ...
    const filteredNews = news.filter((item) => {
        const matchesSource = sourceFilter === "All Sources" || item.type === sourceFilter
    ...
    return (
        <div className="min-h-screen p-6 bg-background">
            <motion.div
                ...
                className="h-full"
            >
                <Card className="bg-gradient-to-br from-card via-background to-card/80 border-border shadow-lg h-[calc(100vh-3rem)]">
                    <CardHeader>
                    ...
                    <CardContent className="h-[calc(100%-200px)] overflow-hidden">
                        {loading ? (
